...
//   const fetchSecurityCategory = async () =>{
//     setLoading(true)
//     try {
//       const res = await api.get("/products/smartsecurity");
//       setSecurityCategory(res.data.products);
...
//     } catch (error) {
//       toast.error("Failed to fetch security category");
//       console.log(error);
...
//         <h1 className="text-center mb-4">Smart Security Systems</h1>
  ...
  return (
    <>
      ...
      <div className="container my-5">
        <h1 className="text-center mb-5 text-primary">Smart Security Systems</h1>
              ...
              <div className="col" key={product._id}>
                <div className="card h-100 shadow-lg border-0">
                  ...
                  <div
                    ...
                    style={{
                      height: "250px", // Set consistent height for images
                      overflow: "hidden",
                    }}
                  >
                    <img
